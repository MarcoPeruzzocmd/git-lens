  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center px-8 py-8">
      ...
      <div className="flex items-center justify-center mb-6">
        <img src="logo-gitLens.png" alt="GitLens" className="w-[100px] h-[100px]" />
      </div>

      {/* Badge */}
      <p className="text-xs text-subtle tracking-wide mb-6">● Conventional Commits Analyzer</p>
      ...
      {/* Footer */}
      <p className="text-xs text-subtle font-semibold mt-8">Built with Conventional Commits spec</p>
